...
// Per-project, ever-incrementing counter for stable task sequence numbers.
// Never reused — drives the prefixed display id (e.g. ENG-1, ENG-2).
async function nextSeq(slug) {
  return await getKv().incr(`taskseq:${slug}`);
}
